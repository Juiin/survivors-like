...
func _init():
    ...
    upgrade_description = "10% chance for [url][color=#7fd4ff]frozen[/color][/url] enemies to shatter into 5 ice shards on kill, dealing 10 damage each"
    cost = [100, 150, 250, 350, 500, 700, 1000, 1250, 1500, 1750]
